<?php
    ...
    class Request{
        ...
        public static function __callStatic($name, $arguments)
        {
            ...
            switch($name){
                case 'all':{
                    echo"obj->getData: <pre>";print_r($obj->getData());echo"</pre>";
        ...
        public function __call($name, $arguments)
        {
            ...
            switch($name){
                case'test':{
                    echo"<br />__call object method ".$name."<br />func_get_args:<pre>";print_r(func_get_args());echo"</pre><br />";
                }break;
            }
        }
...
<?php
    ...
    $obj = new Request();
    echo"
        <br /><br />echo \$obj->getData()&nbsp;&nbsp;&nbsp;->&nbsp;&nbsp;&nbsp;<b><pre>";print_r($obj->getData());echo"</pre></b>
